...
|-------|-------------|------------|------------|------------|
| [lucataco/comfyui-sdxl-txt2img](https://replicate.com/lucataco/comfyui-sdxl-txt2img) | ComfyUI setup to run SDXL text2img | 14 | 19 | 73.68% |
| [tim1224/kim_jung_gi](https://replicate.com/tim1224/kim_jung_gi) | Kim Jung Gi style drawing | 6 | 10 | 60.00% |
| [joehoover/zephyr-7b-alpha](https://replicate.com/joehoover/zephyr-7b-alpha) | A high-performing language model trained to act as a helpful assistant | 31 | 57 | 54.39% |
| [hilongjw/sdxl-zeke](https://replicate.com/hilongjw/sdxl-zeke) | null | 47 | 92 | 51.09% |
| [sakemin/musicgen-chord](https://replicate.com/sakemin/musicgen-chord) | MusicGen Chord is the modified version of Meta's MusicGen, that can generate music based on audio-based chord conditions or text-based chord conditions. | 12 | 71 | 16.90% |
| [adventurepizza/genshin-impact](https://replicate.com/adventurepizza/genshin-impact) | SDXL fine tuned on Genshin Impact landscape by imageapp.xyz | 26 | 172 | 15.12% |
| [fofr/musicgen-kenji-kawai](https://replicate.com/fofr/musicgen-kenji-kawai) | null | 1 | 7 | 14.29% |
| [cjwbw/daclip-uir](https://replicate.com/cjwbw/daclip-uir) | Controlling Vision-Language Models for Universal Image Restoration | 13 | 114 | 11.40% |
| [nateraw/mistral-7b-openorca](https://replicate.com/nateraw/mistral-7b-openorca) | Mistral-7B-v0.1 fine tuned for chat with the OpenOrca dataset. | 68 | 687 | 9.90% |
| [jamesliuzx/manga](https://replicate.com/jamesliuzx/manga) | null | 34 | 394 | 8.63% |
| [alaradirik/t2i-adapter-sdxl-lineart](https://replicate.com/alaradirik/t2i-adapter-sdxl-lineart) | Modify images using line art | 61 | 790 | 7.72% |
| [cloneofsimo/hotshot-xl-lora-controlnet](https://replicate.com/cloneofsimo/hotshot-xl-lora-controlnet) | Text-to-gif using SDXL, with controlnet and lora support | 30 | 401 | 7.48% |
| [adventurepizza/minimalist-design](https://replicate.com/adventurepizza/minimalist-design) | SDXL fine tuned on minimalist design by imageapp.xyz | 26 | 363 | 7.16% |
| [nandycc/sdxl-mascot-avatars](https://replicate.com/nandycc/sdxl-mascot-avatars) | Fine tuned to generate cute mascot avatars, by aistartupkit.com | 76 | 1189 | 6.39% |
| [catacolabs/yearbook-pics](https://replicate.com/catacolabs/yearbook-pics) | Turn your selfies into a 90's yearbook photo in seconds | 224 | 3834 | 5.84% |
| [jbilcke/sdxl-panorama](https://replicate.com/jbilcke/sdxl-panorama) | First version of my panorama LoRA (use 1024x512) | 25 | 488 | 5.12% |
| [mrharispe/visual-library](https://replicate.com/mrharispe/visual-library) | null | 4 | 84 | 4.76% |
| [zsxkib/diffbir](https://replicate.com/zsxkib/diffbir) | ✨DiffBIR: Towards Blind Image Restoration with Generative Diffusion Prior | 16 | 355 | 4.51% |
| [pwntus/sdxl-woolitize](https://replicate.com/pwntus/sdxl-woolitize) | A fine-tuned SDXL based on felted wool | 29 | 690 | 4.20% |
| [cbh123/sdxl-money](https://replicate.com/cbh123/sdxl-money) | SDXL fine-tuned on currencies | 112 | 3007 | 3.72% |
| [sakemin/musicgen-fine-tuner](https://replicate.com/sakemin/musicgen-fine-tuner) | Fine-tune MusicGen small, medium and melody models | 3 | 88 | 3.41% |
| [stphtan94117/easy-remove-background](https://replicate.com/stphtan94117/easy-remove-background) | null | 38 | 1158 | 3.28% |
| [karanchawla/studio-ghibli](https://replicate.com/karanchawla/studio-ghibli) | Public SDXL model trained on the style of Studio Ghibli | 124 | 3799 | 3.26% |
| [zylim0702/sdxl-lora-customize-model](https://replicate.com/zylim0702/sdxl-lora-customize-model) | Introducing a text-to-image AI that crafts stunning 1024x1024 visuals. Load LoRa models via URLs for instant outputs. Train using this link: https://replicate.com/zylim0702/sdxl-lora-customize-training. | 468 | 14805 | 3.16% |
| [lucataco/hotshot-xl](https://replicate.com/lucataco/hotshot-xl) | 😊 Hotshot-XL is an AI text-to-GIF model trained to work alongside Stable Diffusion XL | 166 | 5303 | 3.13% |
| [brawnyai/balenciaga-men-2023-alpha](https://replicate.com/brawnyai/balenciaga-men-2023-alpha) | BrawnyAi's testing new SDXL training capabilities | 4 | 143 | 2.80% |
| [bemothhyde/sdxl_overwatch](https://replicate.com/bemothhyde/sdxl_overwatch) | This fine-tuned SDXL model is trained with Overwatch heroes images | 26 | 954 | 2.73% |
| [alaradirik/dreamgaussian](https://replicate.com/alaradirik/dreamgaussian) | DreamGaussian: Generative Gaussian Splatting for Efficient 3D Content Creation | 6 | 235 | 2.55% |
| [pagebrain/wuerstchen-v2](https://replicate.com/pagebrain/wuerstchen-v2) | Fast Diffusion for Image Generation, ~3 Seconds | 26 | 1151 | 2.26% |
| [konieshadow/fooocus-api](https://replicate.com/konieshadow/fooocus-api) | Third party Fooocus replicate model | 51 | 2317 | 2.20% |
...
| [jagilley/controlnet-scribble](https://replicate.com/jagilley/controlnet-scribble) | Generate detailed images from scribbled drawings | 4590 |
...
| [mv-lab/swin2sr](https://replicate.com/mv-lab/swin2sr) | 2.8 Million Runs! AI Photorealistic Image Super-Resolution and Restoration | 510 |
...
| [yorickvp/llava-13b](https://replicate.com/yorickvp/llava-13b) | Visual instruction tuning towards large language and vision models with GPT-4 level capabilities | 157 |
