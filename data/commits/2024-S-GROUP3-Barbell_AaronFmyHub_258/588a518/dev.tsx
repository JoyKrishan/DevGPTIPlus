        ...
        <View>
          ...
          <View className={tailwindClasses.mainTile}>
            ...
            <Text className='text-base text-slate-200' style={{ paddingHorizontal: 10 }}>
              ...
              workout data may be shared with friends and the public within the App. However, you
              have control over the visibility settings of your profile and can adjust the privacy
              settings accordingly.
              {'\n\n'}c. Integration with Spotify:{'\n\t\t\t'} Integration with Spotify: If you
              choose to link your Spotify account, we may access your Spotify data through Spotify's
              API to display your current listening activity to others on the App. This feature
          ...
          <View className={tailwindClasses.mainTile}>
            <Text className='text-2x1 text-slate-200' style={{ paddingHorizontal: 10 }}>
              ...
              information as described in this Privacy Policy. We encourage you to review this
