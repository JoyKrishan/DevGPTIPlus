            ...
            may use aggregated and anonymized data for analytical purposes to improve the
          ...
          <Text className='text-2xl text-slate-200' style={{ paddingHorizontal: 10 }}>
            ...
            You may choose not to share certain information or opt-out of specific features or
            services within the App.{'\n\n'}c. Access and Rectification:{'\n\t\t\t'} You have the
            right to access and correct inaccuracies in your personal information held by Barbell.
            {'\n\n'}
          </Text>
          <Text className='text-2xl text-slate-200' style={{ fontSize: 25, paddingHorizontal: 10 }}>
